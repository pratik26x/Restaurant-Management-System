...
class Login:
    ...
    def signup(self):
        ...
        signup_button = Button(signup_window, text="Sign up",
                               command=lambda: self.process_signup(username_entry.get(), password_entry.get(),
                                                                   confirm_entry.get(), signup_window))
