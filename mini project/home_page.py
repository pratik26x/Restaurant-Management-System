...
class RestaurantManagementSystem:
    def __init__(self,home_root):
        ...
        cust_btn_home=Button (main_frame, text="HOME",width=25,height=4,font=("times new roman", 14,"bold"), bg="#FFE5CA", fg="black",  cursor="hand1",relief=RIDGE)
        ...
        cust_btn_home=Button (main_frame, text="CONTACT",command=self.contact,width=25,height=4,font=("times new roman", 14,"bold"), bg="black", fg="gold",  cursor="hand1")
        cust_btn_home.grid(row=0,column=3)

        cust_btn_home=Button (main_frame, text="USER",command=self.user,width=25,height=4,font=("times new roman", 14,"bold"), bg="black", fg="gold",  cursor="hand1")
        ...
        img2=Image.open("Group 292.png")
        img2=img2.resize((1183,600),Image.ANTIALIAS)
        self.photoimg2=ImageTk.PhotoImage(img2)
        lblimg=Label(self.home_root, image=self.photoimg2,relief=RIDGE)
        lblimg.place(x=130, y=250,width=1183,height=600)
        ...
        cust_btn_home=Button (main_home_last2, text="ORDER ONLINE",command=self.oo,width=25,font=("times new roman", 14,"bold"), bg="black", fg="white",  cursor="hand1")
        cust_btn_home.grid(row=0,column=4)
    ...
    def oo(self):
        from online import res
        self.new_window = Toplevel(self.home_root)
        self.app =res(self.new_window)
        self.home_root.withdraw()
