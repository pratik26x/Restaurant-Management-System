...
class User_Win:
    def __init__(self,home_root):
        ...
        self.home_root.maxsize(1520,1080)
        self.home_root.minsize(1520,1080)
       # self.home_root.minsize(1440,1080)
        ...
        cust_btn_home=Button (main_frame, text="CONTACT",width=27,height=4,font=("times new roman", 14,"bold"), bg="black", fg="gold",  cursor="hand1")
        cust_btn_home.grid(row=0,column=3)

        cust_btn_home=Button (main_frame, text="USER",width=27,height=4,font=("times new roman", 14,"bold"), bg="#FFE5CA", fg="black",  cursor="hand1")
        cust_btn_home.grid(row=0,column=4)

        main_home=Frame(self.home_root,relief=RIDGE,bd=0,bg="#FFE5CA")
        main_home.place(x=0,y=238,width=1520,height=1080)
